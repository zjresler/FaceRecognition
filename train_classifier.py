...
training_images = input("----------- Please enter the path to the training image directory: ")

# get the name to save the file to
save_name = input("----------- Save the classifier with a specific name (include .clf at the end): ")
